...
%
\begin{lstlisting}
https://github.com/tanayyadav28/EE3900-Assignments/blob/main/GateAssignment_1/code/GateAssignment_1.py
\end{lstlisting}
Download the latex-tikz codes from: 
%
\begin{lstlisting}
https://github.com/tanayyadav28/EE3900-Assignments/blob/main/GateAssignment_1/code/GateAssignment_1.tex
\end{lstlisting}
\section{Problem}
[Gate EC 2015; Q44]\\For the discrete-time system shown in the figure, the poles of the system transfer function are located at:\\
...
\begin{align}
    ...
    \Therefore x[n] &= y[n] - \frac{5}{6}y[n-1] + \frac{1}{6}y[n-2]
\end{align}
